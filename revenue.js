var options = {
        ...
        var valueNameList = [
            ...
            { name: "ZiAn", show: true },
            { name: "ShuChang", show: true },
            { name: "Lovemimius", show: true },
            { name: "LouYixiao", show: true },
            { name: "QiuYingying", show: true },
            { name: "ChenSanfeiGG", show: true },
            { name: "LiuFangPostureCorrector", show: true },
            { name: "RainbowCouple", show: true },
            { name: "BeibeiTu", show: true },
            { name: "CaoYing", show: true },
