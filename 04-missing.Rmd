...
We should also note that these null values would shall not be an obstacle to our project as these values are here because they hosts are not selling items. Our plan for now would be to delete these rows because they are not related to our questions asked. 
