...
Jessie - Introduction and Conclusion 
Jingyuan - Data sources
Megan - Data transformation and Missing values
To get the result, we would each take one question and provide analysis about that question. For the interactive or animated component, we would decide what finding to present after we each are done with answering the questions and then work together to present the finding. 
